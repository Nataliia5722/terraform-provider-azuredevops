...
* Clone the repo: `git clone https://github.com/Nataliia5722/terraform-provider-azuredevops.git`
...
```bash
$ git clone https://github.com/Nataliia5722/terraform-provider-azuredevops.git
