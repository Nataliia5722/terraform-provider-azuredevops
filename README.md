...
[![Go Report Card](https://goreportcard.com/badge/github.com/Nataliia5722/terraform-provider-azuredevops)](https://goreportcard.com/report/github.com/Nataliia5722/terraform-provider-azuredevops)
...
First clone the repository to: `$GOPATH/src/github.com/Nataliia5722/terraform-provider-azuredevops`

```sh
$ mkdir -p $GOPATH/src/github.com/terraform-providers && cd "$_"
$ git clone git@github.com:Nataliia5722/terraform-provider-azuredevops.git
$ cd terraform-provider-azuredevops
```

Once you've cloned, run the `./scripts/build.sh` and `./scripts/local-install.sh`, as recommended [here](https://github.com/Nataliia5722/terraform-provider-azuredevops/blob/main/docs/contributing.md#3-build--install-provider).
